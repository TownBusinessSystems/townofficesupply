      ...
      <main className="flex-grow container mx-auto px-4 py-8 max-w-4xl">
        <div className="prose dark:prose-invert max-w-none">
          ...
          <ul>
            ...
            <li>
              <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Town Business Systems, 170 Kerry Pl, Norwood, MA 02062.</p>
            </li>
            <li>
            ...
            <li>
              <p><strong>Website</strong> refers to Town Office Supply, accessible from <a href="https://townofficesupply.com" rel="external nofollow noopener" target="_blank">townofficesupply.com</a></p>
            </li>
            <li>
          ...
          <ul>
            <li><p>By email: info@townbusiness.com</p></li>
            <li><p>By phone number: 7817621900</p></li>
          </ul>
        </div>
      </main>
