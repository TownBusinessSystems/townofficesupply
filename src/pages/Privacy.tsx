      ...
      <main className="flex-grow container mx-auto px-4 py-8 max-w-4xl">
        <div className="prose dark:prose-invert max-w-none">
          ...
          <ul>
            ...
            <li>
              <p><strong>Website</strong> refers to TonerEmpire, accessible from <a href="https://tonerempire.com" rel="external nofollow noopener" target="_blank">tonerempire.com</a></p>
            </li>
            <li>
